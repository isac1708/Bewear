    ...
    return (
       <Card className="mt-5">
        ...
        <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-muted-foreground font-medium">{formatCentesToBRL(subtotalInCents)}</p>
        </div>
        <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-muted-foreground font-medium">{formatCentesToBRL(totalInCents)}</p>
        </div>
        <div className="py3">
            <Separator/>
        </div>
      ...
      <div className="flex flex-col items-end justify-center gap-2">
        <p className="text-sm font-bold">
          {formatCentesToBRL(product.priceInCents)}
        </p>
      </div>
    </div>))}
        </CardContent>
